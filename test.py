...
Run (CLI):
  # .env is auto-loaded from CWD and script dir
  pip install pandas scikit-learn openai langgraph pydantic python-dotenv httpx
...
# --- Load .env from both CWD and script dir BEFORE reading env vars ---
